...
exports.default = AppWeeklySales;

var _react = require("@iconify/react");

var _androidFilled = _interopRequireDefault(require("@iconify/icons-ant-design/android-filled"));
...
const IconWrapperStyle = (0, _styles.styled)('div')(_ref2 => {
  ...
  return {
    ...
    backgroundImage: "linear-gradient(135deg, ".concat((0, _styles.alpha)(theme.palette.primary.dark, 0), " 0%, ").concat((0, _styles.alpha)(theme.palette.primary.dark, 0.24), " 100%)")
  };
}); // ----------------------------------------------------------------------
