...
const posts = [...Array(23)].map((_, index) => ({
  ...
  cover: (0, _mockImages.mockImgCover)(index + 1),
  title: POST_TITLES[index + 1],
  createdAt: _faker.default.date.past(),
  view: _faker.default.datatype.number(),
  comment: _faker.default.datatype.number(),
  share: _faker.default.datatype.number(),
  favorite: _faker.default.datatype.number(),
  author: {
    name: _faker.default.name.findName(),
    avatarUrl: "/static/mock-images/avatars/avatar_".concat(index + 1, ".jpg")
  }
}));
var _default = posts;
